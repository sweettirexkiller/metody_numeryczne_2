...
[lambda, v, ~, it] = odwrotna_metoda_potegowa(a, b, c, mu, tol, maxIter);
% 
...
% norm(mnozenie_wejsciowy_trojdiagonal_wektor(a,b,c,v') - lambda*v)/norm(lambda*v)
norm(mnozenie_wejsciowy_trojdiagonal_wektor(a,b,c,v) - lambda*v)

mnozenie_wejsciowy_trojdiagonal_wektor(a,b,c,v);

% lambda - norm(lambda*v)
