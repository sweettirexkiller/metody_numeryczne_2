function [B] = Givens_kopia(A,x)
% Projekt 2, zadanie 35
% Sebastian Prokop, 320728
% 
% Funkcja pomocnicza do test3, wykonuje deflację 
...
% Wyjście:
%   B   - macierz po przeprowadzeniu deflacji
...
%  B = A(2:n,2:n); -- KOPIA -- ten element jest pomijany.
B = A;